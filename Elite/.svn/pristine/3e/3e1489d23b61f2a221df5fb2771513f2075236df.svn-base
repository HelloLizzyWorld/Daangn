...
<script>
	...
	$(document).ready(function() {
		 ...
		 $('#admin_pop_content1').html(str);  

	/* 	$("#admin_pop_content1").text(content); */
					...
					<ul>
						...
						<li><label for="content" class="admin_pop_content"
							id="admin_pop_content">내용</label> <textarea
								class="admin_pop_content_textarea" id="admin_pop_content1" name="ncontent"></textarea></li>
				 	<input type="hidden" id="dd" value="${vo.ncontent}"> 
						<li><label>파일</label>
						 <c:choose>
